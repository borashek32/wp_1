  ...
  <header class="header">
    <div class="container">
      <div class="header__top">
        <?php the_custom_logo(); ?>
        <a href="tel:<?php the_field('phone_without_spaces') ?>">
          <h2 class="phone"><?php the_field('phone') ?></h2>
        </a>
      </div>
      <div class="header__content">
        ...
        <a class="button" href="#consult">КОНСУЛЬТАЦИЯ ЭКСПЕРТА</a>
        ...
        <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('image-main'); ?>"
          alt="ford mustang">
      </div>
    </div>
  </header>